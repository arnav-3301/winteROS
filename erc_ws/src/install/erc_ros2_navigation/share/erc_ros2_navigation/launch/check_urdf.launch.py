...
def generate_launch_description():
    ...
    pkg_erc_ros2_navigation = FindPackageShare('erc_ros2_navigation')
    default_rviz_config_path = PathJoinSubstitution([pkg_erc_ros2_navigation, 'rviz', 'urdf.rviz'])
    ...
    # URDF model path within the erc_ros2_navigation package
    ...
    urdf = IncludeLaunchDescription(
        ...
        launch_arguments={
            'urdf_package': 'erc_ros2_navigation',
